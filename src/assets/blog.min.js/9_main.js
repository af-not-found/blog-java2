...
afnfblog.pagenator = function(pagingPath) {
	...
	var f = function() {
		...
		var path = afnfblog.contextRoot + pagingPath;
...
afnfblog.movePageRelative = function(relative) {
	var href = afnfblog.contextRoot + relative;
	afnfblog.movePage(href)
	return false;
};
